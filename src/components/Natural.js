...
const AllProducts = () => {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const filteredProducts = response.data.filter(product => product.Ma_loai === 101); // Lọc sản phẩm theo mã loại 101
                    ...
                    <div className="row">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Kim cương tự nhiên</li>
                            </ol>
                        </nav>
                    </div>
                </div>
